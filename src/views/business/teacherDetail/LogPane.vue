...
export default {
  ...
  cruds() {
    return CRUD({ title: '教师日志', idField: 'userId', url: 'ljadmin/teacher/queryLog' })
  },
  mixins: [presenter(), header(), form(defaultForm), crud()],
  data() {
    return {
      teacherId: Number(this.$route.params.teacherId)
    }
  },
  computed: {},
  mounted() {
  ...
  methods: {
    [CRUD.HOOK.beforeRefresh](curd) {
      curd.query = { ...curd.query, ...this.query, teacherId: this.teacherId }
      return true
    }
  }
}
